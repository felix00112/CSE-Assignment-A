...
func (c *wishlistServiceClient) AddWishlist(ctx context.Context, in *AddWishlistRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, WishlistService_AddWishlist_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wishlistServiceClient) AddItem(ctx context.Context, in *AddToWishlistRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *wishlistServiceClient) EmptyWishlist(ctx context.Context, in *EmptyWishlistRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, WishlistService_EmptyWishlist_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWishlistServiceServer) AddWishlist(context.Context, *AddWishlistRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddWishlist not implemented")
}
func (UnimplementedWishlistServiceServer) AddItem(context.Context, *AddToWishlistRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddItem not implemented")
}
...
func _WishlistService_AddWishlist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WishlistService_AddWishlist_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WishlistService_AddItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WishlistServiceServer).AddItem(ctx, req.(*AddToWishlistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WishlistService_EmptyWishlist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(WishlistServiceServer).EmptyWishlist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WishlistService_EmptyWishlist_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WishlistServiceServer).EmptyWishlist(ctx, req.(*EmptyWishlistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
