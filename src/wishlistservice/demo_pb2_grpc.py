...
class WishlistServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.AddWishlist = channel.unary_unary(
                '/hipstershop.WishlistService/AddWishlist',
                request_serializer=demo__pb2.AddWishlistRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                _registered_method=True)
        self.AddItem = channel.unary_unary(
                '/hipstershop.WishlistService/AddItem',
                request_serializer=demo__pb2.AddToWishlistRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                _registered_method=True)
...
def add_WishlistServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddWishlist': grpc.unary_unary_rpc_method_handler(
                    servicer.AddWishlist,
                    request_deserializer=demo__pb2.AddWishlistRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
            'AddItem': grpc.unary_unary_rpc_method_handler(
                    servicer.AddItem,
                    request_deserializer=demo__pb2.AddToWishlistRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.WishlistService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hipstershop.WishlistService', rpc_method_handlers)
...
class WishlistService(object):
    ...
    def AddWishlist(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.WishlistService/AddWishlist',
            demo__pb2.AddWishlistRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def AddItem(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.WishlistService/AddItem',
            demo__pb2.AddToWishlistRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
